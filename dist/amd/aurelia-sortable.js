define(['exports', 'aurelia-framework', 'sortable', 'aurelia-event-aggregator'], function (exports, _aureliaFramework, _sortable, _aureliaEventAggregator) {
  'use strict';
  ...
  var SortableCustomAttribute = (function () {
    ...
    _createDecoratedClass(SortableCustomAttribute, [{
      ...
      value: function createSortable() {
        ...
        this.mySortable = new _sortable2['default'](this.element, this.configuration);
      }
    }, {
      key: 'destroySortable',
    ...
    SortableCustomAttribute = (0, _aureliaFramework.inject)(Element, _aureliaEventAggregator.EventAggregator)(SortableCustomAttribute) || SortableCustomAttribute;
